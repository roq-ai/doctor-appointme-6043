...
function AppointmentViewPage() {
  ...
  const queryParams = useMemo<{ include: { patient: boolean; healthcare_provider: boolean } }>(
    () =>
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Appointment Status" text={data?.appointment_status} />
                  ...
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/healthcare-providers/view/${data?.healthcare_provider?.id}`}>
                        {data?.healthcare_provider?.specialty + ''}
                      </Link>
                    }
                  />
                )}
