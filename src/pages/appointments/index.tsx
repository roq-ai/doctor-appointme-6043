...
export function AppointmentListPage(props: AppointmentListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['patient', 'healthcare_provider'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['reason_for_visit.contains', 'appointment_status.contains', 'notes.contains'],
          ...params.filters,
        },
        'appointment',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'appointment_status', header: 'Appointment Status', accessorKey: 'appointment_status' },
    ...
    hasAccess('healthcare_provider', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            ...
            >
              {record.healthcare_provider?.specialty}
            </Link>
          ),
        }
      : null,
