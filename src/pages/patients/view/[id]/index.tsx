...
function PatientViewPage() {
  ...
  const queryParams = useMemo<{
    include: { insurance_provider: boolean; user: boolean; healthcare_provider: boolean };
  }>(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['insurance_provider', 'user', 'healthcare_provider'],
          id,
        },
        'patient',
      ),
